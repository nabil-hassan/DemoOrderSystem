...
public class BaseDataInitialiser {
    ...
    public void setupDatabase() {
        ...
        mantis.setBasket(new Basket(mantis));
        ...
        alice.setBasket(new Basket(alice));
        customerDAO.create(alice);
        CreditCard aliceCard = new CreditCard(alice, "Ms A Wright", "8070605040302010", "40-50-60", "11/19", 677);
